...
The RDF in this checkout contains 26 top-level bibliographic items with 26 attachments:

- 10 stored PDFs copied into Zotero storage;
- 16 linked official PDF URLs;
...
Shared-reading essays and synthetic scenarios are website content, not extra bibliographic items in the RDF. Recuris, Cache-to-Cache, Cross-Model KV Cache Transfer, and The Pain Axis use official PDF links; this update does not update an already-imported Zotero library.
