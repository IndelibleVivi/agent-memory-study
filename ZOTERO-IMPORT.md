...
The RDF in this checkout contains 24 top-level bibliographic items with 24 attachments:

- 10 stored PDFs copied into Zotero storage;
- 14 linked official PDF URLs;
...
Shared-reading essays and synthetic scenarios are website content, not extra bibliographic items in the RDF. Recuris and Cache-to-Cache use official PDF links; this update does not update an already-imported Zotero library.
