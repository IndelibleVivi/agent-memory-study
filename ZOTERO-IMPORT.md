...
The expected result for current `main` is 23 top-level bibliographic items with 23 attachments:

- 10 stored PDFs copied into Zotero storage;
- 13 linked official PDF URLs;
...
Shared-reading essays and synthetic scenarios are website content, not extra bibliographic items in the RDF. Recuris is an official PDF link; this update does not update an already-imported Zotero library.
